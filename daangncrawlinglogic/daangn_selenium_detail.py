...
def selenuim_detail(itemName, crawling_date):
    csv_data = pd.read_csv('data_day/' + crawling_date + '_' + itemName + '.csv', encoding='CP949')
    ...
    # 작업이 완료됐다면 저장
    fileHelper.CreateFolder('data_day_comp')
    csv_data.to_csv('data_day_comp/' + crawling_date + '_' + itemName + 'data_comp.csv', encoding="utf-8-sig")
